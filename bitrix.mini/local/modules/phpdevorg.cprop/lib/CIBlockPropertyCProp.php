...
class CIBlockPropertyCProp 
{
    ...
    public function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        foreach ($arFields as $code => $arItem){
            if($arItem['TYPE'] === 'string'){
                ...
                $result .= self::showHTMLConsole($code, $arItem['TITLE'], $value, $strHTMLControlName);
            }
	...
	/*                         TODO                     */
	public static function showHTMLConsole($code, $title, $value, $strHTMLControlName)
	{
		$html = '';
    ...
    private static function getOptionList($selected = 'string')
    {
        ...
        $arOption = [
			...
			'html' => Loc::getMessage('IEX_CPROP_FIELD_TYPE_HTML_CONSOLE')
        ];
